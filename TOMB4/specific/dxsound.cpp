...
int playSample(long num, long volume, long pitch, long pan, ulong flags);
...
{	
	return playSample(num, volume, pitch, pan, flags);
	//long channel = -1;
